...
open class DatePickerDialog: UIView {
    ...
    open func show(_ title: String,
        ...
        //NotificationCenter.default.addObserver(self,selector: .deviceOrientationDidChange,name: UIDevice.NSNotification.Name.UIDeviceOrientationDidChange, object: nil)
